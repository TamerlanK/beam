export const ICONS = {
  ...
  phone:
    "M7 2.5h10a2.5 2.5 0 0 1 2.5 2.5v14a2.5 2.5 0 0 1-2.5 2.5H7A2.5 2.5 0 0 1 4.5 19V5A2.5 2.5 0 0 1 7 2.5zM10.5 18.5h3",
  tablet:
    "M7 3h10a2.5 2.5 0 0 1 2.5 2.5v13A2.5 2.5 0 0 1 17 21H7a2.5 2.5 0 0 1-2.5-2.5v-13A2.5 2.5 0 0 1 7 3zM10 18h4",
  laptop:
    "M5.5 5h13A1.5 1.5 0 0 1 20 6.5v9.5H4V6.5A1.5 1.5 0 0 1 5.5 5zM2.5 19h19",
  file: "M6 3h8l4 4v14H6zM14 3v4h4",
  image:
    "M5 5h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2zM21 16l-5-5-8 8M8.5 10.5h.01",
  video:
    "M5 5h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2zM10 9l5 3-5 3z",
  audio:
  ...
  sheet:
    "M5 4h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zM3 10h18M3 15h18M9 4v16",
...
for (const [kind, list] of Object.entries(KINDS))
  for (const e of list.split(" ")) EXT.set(e, kind);
